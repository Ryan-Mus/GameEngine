...
bool PacmanMovement::SetDirection(const glm::vec3& direction)
{
...
bool PacmanMovement::IsAlignedWithGrid() const
{
...
void PacmanMovement::SnapToGridAlignment()
{
...
bool PacmanMovement::CanMoveInDirection(const glm::vec3& direction)
{
	auto pos = GetOwner()->GetLocalPosition();
